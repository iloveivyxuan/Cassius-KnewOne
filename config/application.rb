...
module Making
  class Application < Rails::Application
    ...
    config.autoload_paths += %W(#{config.root}/lib
                                ...
                                #{config.root}/lib/omniauth/strategies)
    ...
    config.action_view.sanitized_allowed_tags = ['embed', 'iframe', 'strike', 'u', 'table', 'td', 'tr', 'thead', 'tbody', 'tfoot', 'th', 'article', 'header', 'section', 'footer']
    config.action_view.sanitized_allowed_attributes = ['src','target', 'data-knewone-embed-type', 'data-knewone-embed-key', 'data-knewone-embed-id', 'contenteditable', 'data-score', 'data-profile-popover']
