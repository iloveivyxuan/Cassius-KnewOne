...
module Making
  class Application < Rails::Application
    ...
    config.action_view.sanitized_allowed_attributes = ['src','target', 'data-knewone-embed-type', 'data-knewone-embed-id', 'contenteditable', 'data-score', 'data-profile-popover']
