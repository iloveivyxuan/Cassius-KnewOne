...
(function ($) {
  ...
  $.fn.mediumInsert.registerAddon('embeds', {
    ...
    add : function ($placeholder) {
      ...
      var formHtml = '<div class="medium-editor-toolbar-form-anchor mediumInsert-embedsWire" style="display: block;"><input type="text" value="" contenteditable="false" placeholder="粘贴视频代码并回车" class="mediumInsert-embedsText"></div>';
