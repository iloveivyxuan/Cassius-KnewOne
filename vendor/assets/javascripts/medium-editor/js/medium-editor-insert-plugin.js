    ...
    if (typeof options === 'string' && $.fn.mediumInsert.insert[options]) {
      ...
      */
      ...
      return this.each(function () {
        ...
        if ($.fn.mediumInsert.settings.videos === true) {
          $.fn.mediumInsert.videos.init();
        }
    ...
    */
    ...
    setPlaceholders: function () {
      var that = this,
          ...
          insertImage = $.fn.mediumInsert.settings.images ?
            '<li><a class="mediumInsert-action action-images-add">图片</a></li>' : '',
          insertVideo = $.fn.mediumInsert.settings.videos ?
            '<li><a class="mediumInsert-action action-videos-add">视频</a></li>' : '',
          insertMap = $.fn.mediumInsert.settings.maps ?
            '<li><a class="mediumInsert-action action-maps-add">地图</a></li>' : '',
          insertBlock = '<a class="mediumInsert-buttonsShow">插入</a>' +
    ...
    */
    ...
    setEvents: function () {
      ...
      $el.on('click', '.mediumInsert-buttons .mediumInsert-action', function () {
        var $this = $(this),
            action = $this.attr('class').split('action-')[1].split('-'),
        ...
        if ($.fn.mediumInsert[action[0]] && $.fn.mediumInsert[action[0]][action[1]]) {
          $.fn.mediumInsert[action[0]][action[1]]($placeholder, $this);
        }
