class ThingsController < ApplicationController
  ...
  def lists
    @lists = @thing.lists.gte(fanciers_count: 1, size: 4).desc(:fanciers_count)
  ...
  def thing_params
    ...
    if (@thing ||= Thing.new) || (@thing.author == current_user || !@thing.persisted?) && current_user.role?(:volunteer)
