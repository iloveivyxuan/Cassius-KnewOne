            ...
            return {
                ...
                bindSaveData: function() {
                    ...
                    self.targets.each( function() {
                        ...
                        var fieldsToProtect = $( this ).find( ":input, [contenteditable='true']" ).not( ":submit" ).not( ":reset" ).not( ":button" ).not( ":file" );
                        ...
                        fieldsToProtect.each( function() {
                            ...
                            if ( field.is( ":text" ) || field.is( "textarea" ) || field.attr( "contenteditable" ) == "true" ) {
                                if ( ! self.options.timeout ) {
                ...
                saveAllData: function() {
                    ...
                    self.targets.each( function() {
                        ...
                        fieldsToProtect.each( function() {
                            ...
                            } else if ( field.attr( "contenteditable" ) == "true" ) {
                                value = field.html()
                                self.saveToBrowserStorage( prefix, value, false );
                            } else {
                                self.saveToBrowserStorage( prefix, value, false );
                ...
                restoreAllData: function() {
                    ...
                    self.targets.each( function() {
                        ...
                        var fieldsToProtect = target.find( ":input, [contenteditable='true']" ).not( ":submit" ).not( ":reset" ).not( ":button" ).not( ":file" );
